...
<p> MoreThanGames built the Robinson’s Island app as ad-supported app. This SERVICE is provided by MoreThanGames and is intended
    for use as is.</p>
...
<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
    which is accessible at Robinson’s Island, unless otherwise defined in this Privacy Policy.</p>

<p><strong>Information Collection and Use</strong></p>
<p>For a better experience while using our Service, we may require you to provide certain
    personally identifiable information, including but not limited to phone state. 
	The information that we request is not
    collected by us in any way and used as described in this privacy policy.</p>
